...
function App() {
  ...
  <div>
   ...
   <Navbar className="bg-body-primary" style={{backgroundColor:"#2bb550"}} >
      <Container className="yy" >
...
<div className="three " >
    ...
    <h1 className="qq" style={{textShadow:"3px 1px"}}>Hi! I'm!</h1>
    ...
    <button style={{width:'100px',borderRadius:"15px"}} className="gg">Hire Me</button>
    <button  className="gg" style={{width:'100px',borderRadius:"15px",marginLeft:"15px",backgroundColor:"white", color:"#2bb550",border:"1px solid green"}}>Yes Talk</button>
...
<div>
<div className="four" id="dd" >
  <div className="five" style={{alignItems:"center"}}  >
